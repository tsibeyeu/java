...
public class Student1 { //class creation and field variable declaration
    int id;
    ...
    public void setName(String hermon) {
...
class main2 extends Student1{
    main2(int id, String name) {
        super(id, name);
    }
...
class main {
    public static void main(String[] args) {
        Student1 studentInfo = new Student1(2123, "John");

        studentInfo.setName("tsion");
        ...
        pf=sc.nextDouble();
        netSalary=Student1.salary(gs,pf,pt,it);
